...
| Name | Summary |
|---|---|
| [HabitRepository](-habit-repository/index.md) | [app]<br>class [HabitRepository](-habit-repository/index.md)@Injectconstructor(habitDao: [HabitDao](../com.habithatch.demo.data.daos/-habit-dao/index.md), habitMapper: [HabitMapper](../com.habithatch.demo.data.mappers/-habit-mapper/index.md), userRepository: [UserRepository](-user-repository/index.md))<br>[HabitRepository](-habit-repository/index.md) is a repository that provides access to habits in the database. |
